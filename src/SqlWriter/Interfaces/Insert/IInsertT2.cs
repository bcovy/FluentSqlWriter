...
public interface IInsert<TInsert, T, T2> : ISqlStatement where TInsert : class where T : class where T2 : class
{
    /// <summary>
    ...
    /// check that will short-circuit the statement if the result of <see cref="IInsert{TInsert, T, T2}"/> did not affect any rows.
    /// </summary>
    /// <remarks>
    /// It is recommended that building of the next statement be done using the fluent build methods on this object.  This helps to 
    /// ensure the last statement in the chain is able to compile all preceding statements into one. If you choose to break up 
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Into<TProjection>() where TProjection : class;
    /// <summary>
    /// Sets the target columns to use in the INTO clause of the statement.
    /// </summary>
    /// <param name="columns">INTO target columns.</param>
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Into(Expression<Func<TInsert, object>> columns);
    /// <summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> OutputTo<TOutputTo>(Expression<Func<TInsert, TOutputTo>> statement) where TOutputTo : class;
    /// <summary>
    ...
    /// </summary>
    /// <typeparam name="TProjection">Projection model type.</typeparam>
    /// <returns><see cref="IInsert{TInsert, T2, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Select<TProjection>() where TProjection : class;
    /// <summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Select(Expression<Func<T, T2, object>> columns);
    /// <summary>
    /// Join tables <typeparamref name="TTable1"/> and <typeparamref name="TTable2"/> using Primary Key field identified
    /// in <see cref="TableNameAttribute"/>. By convention, method will assume Primary Key name in <typeparamref name="TTable1"/>
    /// has an associated field name in <typeparamref name="TTable2"/>.
    /// </summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Join<TTable1, TTable2>(JoinType joinType = JoinType.Inner) where TTable1 : class where TTable2 : class;
    /// <summary>
    ...
    /// <param name="joinType">Join type.</param>
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Join(Expression<Func<T, T2, bool>> columns, JoinType joinType = JoinType.Inner);
    /// <summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> JoinInner(Expression<Func<T, T2, bool>> columns);
    /// <summary>
    ...
    IInsert<TInsert, T, T2> JoinLeftOuter(Expression<Func<T, T2, bool>> columns);
    /// <summary>
    ...
    IInsert<TInsert, T, T2> Where(Expression<Func<T, T2, bool>> expression);
    /// <summary>
    /// Specifies a subquery to constrain records from an outer query.  <typeparamref name="TExists"/> represents
    /// the subquery entity, and <typeparamref name="TOuter"/> represents the outer query entity.
    /// </summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain query methods.</returns>
    IInsert<TInsert, T, T2> WhereExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// include additional filter criteria.</param>
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain query methods.</returns>
    IInsert<TInsert, T, T2> WhereNotExists<TExists, TOuter>(Expression<Func<TExists, TOuter, bool>> expression) where TExists : class where TOuter : class;
    /// <summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> WhereSubquery<TColumn>(Expression<Func<T, T2, TColumn>> expression, Func<ISubquery> subquery);
    /// <summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> GroupBy<TProperty>(Expression<Func<T, T2, TProperty>> column);
    /// <summary>
    ...
    /// <param name="column">Column.</param>
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> GroupBy(Expression<Func<T, T2, object>> column);
    /// <summary>
    ...
    /// <returns><see cref="IInsert{TInsert, T, T2}"/> object to allow user to chain statement methods.</returns>
    IInsert<TInsert, T, T2> Having(Expression<Func<T, T2, bool>> condition);
}