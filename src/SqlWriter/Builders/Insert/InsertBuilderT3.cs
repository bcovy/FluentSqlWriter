    ...
    IInsert<TInsert, T, T2, T3> where TInsert : class where T : class where T2 : class where T3 : class
{
    ...
    public IInsert<TInsert, T, T2, T3> JoinInner(Expression<Func<T, T2, T3, bool>> columns)
    {
    ...
    public IInsert<TInsert, T, T2, T3> JoinLeftOuter(Expression<Func<T, T2, T3, bool>> columns)
    {
